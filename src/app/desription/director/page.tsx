...
<div style={{display:"flex",  justifyContent:"center" }}> <h1  style={{ fontWeight: "bold", fontSize: "1.5rem" }}>Dr. Agile Mathew</h1>
</div>

<div style={{display:"flex",  justifyContent:"center" }}> <h1  style={{ fontWeight: "bold", fontSize: "1rem" }}>Faculty-in-Charge(T&P Cell), Central Institute Of Technology, Kokrajhar</h1>
</div>
